...
if TYPE_CHECKING:
    from shared_code.terrabot_core_typing import (
        ...
        build_agent_input_for_aws_module_creation,
        build_branch_name,
        build_pr_body,
        build_stable_folder,
        ...
        normalize_cloud,
        normalize_module_variables_tf_content,
