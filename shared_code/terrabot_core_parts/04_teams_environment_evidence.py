...
if TYPE_CHECKING:
    from shared_code.terrabot_core_typing import (
        ...
        _ACTIVE_TEAMS_REQUESTER,
        _ACTIVE_TEAMS_REQUESTER_DISPLAY,
        _TEAMS_ENV_EVIDENCE_MAX_FILES,
        _TEAMS_ENV_EVIDENCE_PER_FILE_CHARS,
        _TEAMS_ENV_EVIDENCE_TOTAL_CHARS,
        _TEAMS_ENV_TOKEN_STOPWORDS,
        _TEAMS_VALUE_WALK_MAX_DEPTH,
        _TEAMS_VALUE_WALK_MAX_DIRS,
        _TEAMS_VALUE_WALK_MAX_FILES,
        ...
        _teams_truthy,
        _teams_unique_branch_name,
        _validate_azure_repo_merge_commit_settings,
        build_pr_body,
        ...
        normalize_azure_module_repo_population_path,
        normalize_cloud,
        ...
        validate_aws_module_creation_payload,
