...
if TYPE_CHECKING:
    from shared_code.terrabot_core_typing import (
        ...
        AZURE_MODULE_POPULATION_REQUIRED_FILES,
        AZURE_MODULE_REPO_TARGET,
        BACKEND_CONTEXT_SOURCE_PREFIXES,
        DISABLE_EXTERNAL_RAG_CONTEXT,
        GITHUB_AZURE_BASE_BRANCH,
        GITHUB_AZURE_REPO,
        GITHUB_OWNER,
        GITHUB_PR_SOURCE_BRANCH_AZURE,
        GITHUB_VENA_REPO,
        ...
        _azure_consumer_module_name_from_module_context,
        _content_contains_existing_file,
        _dedupe_preserving_order,
        _dominant_object_var_root,
        _ensure_azure_consumer_variables_tf_declarations,
        _extract_hcl_assignment_value,
        _extract_required_variable_names_from_text,
        _extract_tf_output_names_from_text,
        _extract_tf_variable_names_from_text,
        _extract_tfvars_assignments_from_text,
        _extract_top_level_hcl_assignment_names,
        _extract_var_roots_from_text,
        _find_agent_file_by_name_or_suffix,
        _generated_tfvars_assignment_should_be_replaced,
        ...
        _list_tf_files_by_repo_ref,
        _merge_terraform_content_preserving_existing,
        _module_object_field_for_input,
        _new_matching_module_blocks,
        _normalize_type_expr,
        _normalized_hcl_content_for_compare,
        _repair_azure_consumer_module_invocations,
        _repair_azure_consumer_variables_tf_files_in_agent_result,
        _repair_unclosed_variables_tf_content_for_write,
        _replace_top_level_tfvars_assignment,
        _require_setting,
        _strip_hcl_inline_comment,
        _terraform_safe_variable_name,
        _tfvars_object_name_from_module_name,
        _top_level_tfvars_assignment_field_names,
        _top_level_tfvars_assignment_span,
        ...
        build_backend_variable_declaration_context,
        build_new_azure_consumer_file_routing_context,
        call_agent,
        clear_pending_cloud_clarification,
        commit_azure_module_repo_population_files,
        commit_terraform_files_to_repo,
        enforce_verified_aws_module_sources,
        enrich_agent_result_with_module_repo_target,
        ensure_azure_consumer_variables_tf_file,
        ensure_thread_meta,
        find_agent_reference,
        get_project_client,
        github_base_branch_for_cloud,
        github_branch_exists,
        github_branch_exists_by_repo,
        github_find_pr_by_branch,
        github_find_pr_by_branch_by_repo,
        github_get_file_content,
        github_get_file_content_by_repo,
        github_get_pull_request,
        github_get_pull_request_by_repo,
        github_get_repo,
        github_get_repo_default_branch,
        github_list_matching_branches_by_repo,
        github_list_pull_request_files,
        github_list_pull_request_files_by_repo,
        github_repo_exists,
        github_repo_for_cloud,
        hashlib,
        infer_cloud_from_prompt,
        json,
        load_existing_tf_files_for_context,
        ...
        sanitize_azure_module_repo_name,
        stable_thread_key,
