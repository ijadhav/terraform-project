...
def handle_generate_request(data: Dict[str, Any], headers=None) -> tuple:
    ...
    if context_pack and isinstance(context_pack, dict):
        ...
        return _call_foundry_and_return(prompt, context_pack, thread_id=thread_id)
    ...
    return _call_foundry_and_return(prompt, cp, base_plan=plan, thread_id=thread_id, existing_files=existing_map)
